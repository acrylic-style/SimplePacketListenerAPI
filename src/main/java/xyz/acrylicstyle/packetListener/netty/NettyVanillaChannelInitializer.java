...
import static xyz.acrylicstyle.packetListener.util.ReflectionUtil.getConnectedChannelField;
import static xyz.acrylicstyle.packetListener.util.ReflectionUtil.newInstance;
    ...
    protected void initChannel(SocketChannel channel) {
        ...
        try {
            ...
            Object handshakeListener = Class.forName(ReflectionUtil.nms("HandshakeListener"))
                    .getConstructor(SimplePacketListenerPlugin.MinecraftServer, SimplePacketListenerPlugin.NetworkManager)
                    .newInstance(minecraftServer, networkManager);
            SimplePacketListenerPlugin.NetworkManager
