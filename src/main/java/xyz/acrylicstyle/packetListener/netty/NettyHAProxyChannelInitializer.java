            ...
            public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
                if (msg instanceof HAProxyMessage) {
                    try {
                        ...
                        try {
                            SimplePacketListenerPlugin.NetworkManager.getField("socketAddress").set(handler, address);
                        } catch (NoSuchFieldException ex) {
                            SimplePacketListenerPlugin.NetworkManager.getField("l").set(handler, address);
                        }
